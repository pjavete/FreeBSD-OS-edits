...
How to complie and run:
	...
	6. You may have to adjust the number before M based on the amount of memory on your VM. It represents doing a Malloc of x MB per vm worker. Additionally it may crash the VM but when it boots back up you should be able to run it just fine.
